...
#         # Find all the face image paths
#         registered_faces = []
#         for user_id, user_info in users_db.items():
#             registered_faces.append(user_info["face_path"])
...
#                 # Get the path of the most similar face
...
#                 if recognized_user:
#                     # Record attendance
#                     attendance_file = os.path.join(ATTENDANCE_DIR, f"attendance_{time.strftime('%Y-%m-%d')}.txt")
#                     with open(attendance_file, "a") as f:
#                         f.write(f"{recognized_user['userId']},{recognized_user['name']},{time.strftime('%Y-%m-%d %H:%M:%S')}\n")
                    
#                     emit('recognition_result', {
#                         "success": True,
#                         "user": recognized_user,
#                         "message": f"Welcome, {recognized_user['name']}!"
#                     })
#                 else:
#                     emit('recognition_result', {
#                         "success": False,
...
#     attendance_file = os.path.join(ATTENDANCE_DIR, f"attendance_{date}.txt")
...
#             for line in f:
#                 if line.strip():
#                     user_id, name, timestamp = line.strip().split(',', 2)
